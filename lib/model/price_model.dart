class PriceRangeModel {
  ...
  int minPrice;
  int? maxPrice;
  PriceRangeModel({this.priceRange, required this.minPrice, this.maxPrice});
}

List<PriceRangeModel> priceRangeList = [
  PriceRangeModel(priceRange: "All", minPrice: 0, maxPrice: null),
  PriceRangeModel(priceRange: "0-200", minPrice: 0, maxPrice: 200),
  ...
  PriceRangeModel(priceRange: "over 2000", minPrice: 2000, maxPrice: null),
];
